...
__vector_table_0x1c
        ...
        DCD     ELS_IRQHandler                                ;ELS and ELS error interrupts
        DCD     PKC_IRQHandler                                ;Public Key Cryptography interrupt
        ...
        DCD     ELS_IRQ1_IRQHandler                           ;ELS_IRQ1
...
Reserved80_IRQHandler
        ...
        PUBWEAK ELS_IRQ1_IRQHandler
        PUBWEAK ELS_IRQ1_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
ELS_IRQ1_IRQHandler
        LDR     R0, =ELS_IRQ1_DriverIRQHandler
        BX      R0

                              ...
                              int32_t pi32_hfXtalNPcbParCappF_x100)
{
    ...
    if ((0UL != (u32XOTrimValue & 1UL)) && (0UL != ((u32XOTrimValue >> 15) & 1UL)))
    {
        ...
        u8IECXinCapCal6pF  = (uint8_t)((u32XOTrimValue >> 1) & 0x7f);
        u8IECXinCapCal8pF  = (uint8_t)((u32XOTrimValue >> 8) & 0x7f);
        u8IECXoutCapCal6pF = (uint8_t)((u32XOTrimValue >> 16) & 0x7f);
        u8IECXoutCapCal8pF = (uint8_t)((u32XOTrimValue >> 23) & 0x7f);
        /* This field is 1 bit */
    ...
    iXOCapInpF_x100 =
        2 * pi32_hfXtalIecLoadpF_x100 - pi32_hfXtalNPcbParCappF_x100 + 39U * ((uint8_t)XO_SLAVE_EN - u8XOSlave) - 15;
